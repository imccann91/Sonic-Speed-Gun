;REAL TIME INTERRUPT FRAMEWORK  RTIC_Char.ASM

;This program implements a simple interrupt driven hex counter on the LED chacter display
;connected to Port B while accepting user input via the DBUG12 GETCHAR() subroutine.
;The user may type a minus (-) or plus (+) to stop or start the counter, respectively,
;or typing a period (.) will disable the RTI hardware and abort the program.
...
RTISR
        ...
        bne        mux
        LDD        #10                ;increment display counter
        std        number
