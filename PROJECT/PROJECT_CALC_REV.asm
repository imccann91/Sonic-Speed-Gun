...
start
        ...
        movb        #61,count           ;init counter for 122 * 8.12 ms
...
;*************************************************************;
        LDAA        SFLG                 ;STORES THE READING INTO TWO SEPERATE LOCATIONS
        CMPA        #1
        LBEQ        STORE2
        LDD         $90
...
CALC
        ...
        CMPA        #1
        BNE         MUX                 ;BRANCHES TO MUX IF THE CALCULATIONS FLAG IS NOT SET
        ;SWI
	LDD         NUM1
        SUBD        NUM2
        BLT         NEGATE               ;NOTE: THIS CALCULATES THE SPEED IN INCHES PER SECOND
	STD         SPEED
        STD         NUMBER
        ;SWI
        BCLR        CFLG,1
...
;****************************************;
        BRA         RSET                 ;KEEPS THE PROGRAM FROM USING NEGATE UNLESS NEEDED
NEGATE                                   ;NEGATES SPEED IF IT'S NEGATIVE
	STD         SPEED
        ...
        EMULS
        STD         NUMBER
        JMP         RSET                ;REMEMBER TO CHANGE ADDRESS
        
;****************************************;
        BRA         RSET                 ;KEEPS THE PROGRAM FROM USING STORE2 UNLESS NEEDED
STORE2                                   ;STORES THE SECOND DISTANCE INTO NUM2 AND RETURNS TO THE MAIN LOOP
        ...
        JMP         CALC
RSET
        MOVB        #61,count           ;reset interrupt counter
